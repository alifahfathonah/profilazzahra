...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`db_profil_azzahra` /*!40100 DEFAULT CHARACTER SET latin1 */;

USE `db_profil_azzahra`;
...
) ENGINE=InnoDB AUTO_INCREMENT=22755 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
