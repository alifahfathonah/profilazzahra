...
class GoogleMap implements ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Google Map', 'stockholm-core'),
			'base'                      => $this->base,
			...
			'params'					=> array(
				array(
					'type'       => 'textfield',
					'param_name' => 'address1',
					'heading'    => esc_html__( 'Address 1', 'stockholm-core' )
				),
				array(
					'type'       => 'textfield',
					'param_name' => 'address2',
					'heading'    => esc_html__( 'Address 2', 'stockholm-core' ),
					'dependency' => Array( 'element' => 'address1', 'not_empty' => true )
				),
				array(
					'type'       => 'textfield',
					'param_name' => 'address3',
					'heading'    => esc_html__( 'Address 3', 'stockholm-core' ),
					'dependency' => Array( 'element' => 'address2', 'not_empty' => true )
				),
				array(
					'type'       => 'textfield',
					'param_name' => 'address4',
					'heading'    => esc_html__( 'Address 4', 'stockholm-core' ),
					'dependency' => Array( 'element' => 'address3', 'not_empty' => true )
				),
				array(
					'type'       => 'textfield',
					'param_name' => 'address5',
					'heading'    => esc_html__( 'Address 5', 'stockholm-core' ),
					'dependency' => Array( 'element' => 'address4', 'not_empty' => true )
				),
				array(
					'type'        => 'dropdown',
					'param_name'  => 'predefined_map_style',
					'heading'     => esc_html__( 'Predefined Map Style', 'stockholm-core' ),
					'value'       => array_flip( stockholm_qode_get_yes_no_select_array( false ) ),
					'description' => esc_html__( 'Enabling this option will set our predefined map style', 'stockholm-core' )
				),
				array(
					'type'        => 'dropdown',
					'param_name'  => 'custom_map_style',
					'heading'     => esc_html__( 'Custom Map Style', 'stockholm-core' ),
					'value'       => array_flip( stockholm_qode_get_yes_no_select_array( false ) ),
					'description' => esc_html__( 'Enabling this option will allow Map editing', 'stockholm-core' ),
					'dependency'  => Array( 'element' => 'predefined_map_style', 'value' => array( 'no' ) )
				),
				array(
					'type'        => 'colorpicker',
					'param_name'  => 'color_overlay',
					'heading'     => esc_html__( 'Color Overlay', 'stockholm-core' ),
					'description' => esc_html__( 'Choose a Map color overlay', 'stockholm-core' ),
					'dependency'  => Array( 'element' => 'custom_map_style', 'value' => array( 'yes' ) )
				),
				array(
					'type'        => 'textfield',
					'param_name'  => 'saturation',
					'heading'     => esc_html__( 'Saturation', 'stockholm-core' ),
					'description' => esc_html__( 'Choose a level of saturation (-100 = least saturated, 100 = most saturated)', 'stockholm-core' ),
					'dependency'  => Array( 'element' => 'custom_map_style', 'value' => array( 'yes' ) )
				),
				array(
					'type'        => 'textfield',
					'param_name'  => 'lightness',
					'heading'     => esc_html__( 'Lightness', 'stockholm-core' ),
					'description' => esc_html__( 'Choose a level of lightness (-100 = darkest, 100 = lightest)', 'stockholm-core' ),
					'dependency'  => Array( 'element' => 'custom_map_style', 'value' => array( 'yes' ) )
				),
				array(
					'type'        => 'attach_image',
					'param_name'  => 'pin',
					'heading'     => esc_html__( 'Pin', 'stockholm-core' ),
					'description' => esc_html__( 'Select a pin image to be used on Google Map', 'stockholm-core' )
				),
				array(
					'type'        => 'textfield',
					'param_name'  => 'zoom',
					'heading'     => esc_html__( 'Map Zoom', 'stockholm-core' ),
					'description' => esc_html__( 'Enter a zoom factor for Google Map (0 = whole worlds, 19 = individual buildings)', 'stockholm-core' )
				),
				array(
					'type'        => 'dropdown',
					'param_name'  => 'scroll_wheel',
					'heading'     => esc_html__( 'Zoom Map on Mouse Wheel', 'stockholm-core' ),
					'value'       => array_flip( stockholm_qode_get_yes_no_select_array( false ) ),
					'description' => esc_html__( 'Enabling this option will allow users to zoom in on Map using mouse wheel', 'stockholm-core' )
				),
				array(
					'type'       => 'textfield',
					'param_name' => 'map_height',
					'heading'    => esc_html__( 'Map Height', 'stockholm-core' )
				)
			)
	...
	public function render($atts, $content = null) {
		...
		return stockholm_qode_get_shortcode_template_part('templates/google-map-template', 'google-map', '', $params);
	}
