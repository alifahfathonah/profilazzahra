    ...
    <div class='filter_holder  <?php echo esc_attr($portfolio_filter_class); ?>'>
        <ul>
            ...
            <?php if (in_array($type, array('standard','standard_no_space','hover_text','hover_text_no_space'))) { ?>
                <li class='filter' data-filter='all'><span><?php esc_html_e('All', 'stockholm-core') ?></span></li>
            <?php }else{ ?>
                <li class='filter' data-filter='*'><span><?php esc_html_e('All', 'stockholm-core') ?></span></li>
            <?php } ?>
