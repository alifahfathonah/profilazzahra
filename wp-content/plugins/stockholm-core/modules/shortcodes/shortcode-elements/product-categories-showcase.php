...
if ( ! function_exists( 'stockholm_qode_shop_category_showcase' ) ) {
	function stockholm_qode_shop_category_showcase( $atts, $content = null ) {
		$args = array(
			'cat_slug'          => '',
			'product_id'        => '',
			'product_id_2'      => '',
		...
		if ( $cat1 ) {
			$category_thumbnail = get_term_meta( $cat1->term_id, 'thumbnail_id', true );
	...
	add_shortcode( 'qode_shop_category_showcase', 'stockholm_qode_shop_category_showcase' );
}