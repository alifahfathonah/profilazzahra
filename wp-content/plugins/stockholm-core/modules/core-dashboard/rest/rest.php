...
if ( ! class_exists( 'StockholmCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class StockholmCoreDashboardRestAPI {
		...
		public function __construct() {
			// Init variables
			$this->set_namespace( 'stockholm-core/v1' );
			$this->set_route( 'dashboard' );

			// Localize theme's main js script with rest variable
			add_filter( 'stockholm_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	StockholmCoreDashboardRestAPI::get_instance();
}