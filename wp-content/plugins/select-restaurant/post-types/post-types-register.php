<?php
namespace StockholmQodeRestaurant\CPT;

use StockholmQodeRestaurant\Lib;

/**
 * Class PostTypesLoader
 * @package StockholmQodeRestaurant\CPT
 */
class PostTypesRegister {
	...
	private function addPostTypes() {
		$cpt_class_name = apply_filters( 'stockholm_qode_filter_restaurant_register_custom_post_types', $cpt_class_name = array() );
