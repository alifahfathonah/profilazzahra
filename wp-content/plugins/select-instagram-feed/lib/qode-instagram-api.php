...
/**
 * Class StockholmQodeInstagramApi
 */
class StockholmQodeInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var StockholmQodeInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var StockholmQodeInstagramHelper
     */
    private $helper;
    ...
    private function __construct() {
        ...
        $this->helper = new StockholmQodeInstagramHelper();
    }
    ...
    /**
     * @return StockholmQodeInstagramApi
     */
     ...
     * @return string
     *
     * @see StockholmQodeInstagramApi::buildCurrentPageURI()
     */
    ...
    /**
     * @return StockholmQodeInstagramHelper
     */
     ...
     *
     * @see StockholmQodeInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see StockholmQodeInstagramApi::getAccessToken()
     */
    ...
    public function disconnectUser() {
       if($this->hasUserConnected()) {
           ...
           if ($response) {
               ...
               $responseObj->message = esc_html__('Couldn\'t disconnect from Instagram', 'select-instagram-feed');
           }
