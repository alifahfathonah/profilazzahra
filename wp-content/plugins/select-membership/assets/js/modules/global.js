...
(function ($) {
    ...
    function qodeUserLogin() {
        $('.qode-login-form').on('submit', function (e) {
            e.preventDefault();
            var ajaxData = {
                action: 'stockholm_qode_action_membership_login_user',
    ...
    function qodeUserRegister() {
        ...
        $('.qode-register-form').on('submit', function (e) {
            ...
            e.preventDefault();
            var ajaxData = {
                action: 'stockholm_qode_action_membership_register_user',
    ...
    function qodeUserLostPassword() {
        ...
        lostPassForm.submit(function (e) {
            e.preventDefault();
            var data = {
                action: 'stockholm_qode_action_membership_user_lost_password',
    ...
    function qodeGetFacebookUserData() {
        ...
        FB.api('/me', 'GET', {'fields': 'id, name, email, link, picture'}, function (response) {
            ...
            var data = {
                action: 'stockholm_qode_action_membership_check_facebook_user',
                response: response
            };
            $.ajax({
                type: 'POST',
    ...
    function qodeSignInCallback() {
        ...
        if (signedIn) {
            var currentUser = window.auth2.currentUser.get(),
                ...
                data = {
                    action: 'stockholm_qode_action_membership_check_google_user',
                    response: userData
                };
            $.ajax({
                type: 'POST',
    ...
    function qodeUpdateUserProfile() {
        ...
        if ( updateForm.length ) {
            ...
            updateForm.on('submit', function (e) {
                ...
                var ajaxData = {
                    action: 'stockholm_qode_action_membership_update_user_profile',
                    data: $(this).serialize()
                };
