$j(document).ready(function() {
    ...
    $j("#panel.default.left a.open").on('click', function(e){
        e.preventDefault();
    ...
    $j("#panel.default.right a.open").on('click', function(e){
        e.preventDefault();
    ...
    $j('ul#tootlbar_page_transitions li').on('click', function(){
        if($j(this).attr("data-value") !== ""){
    ...
    $j('ul#tootlbar_pattern li').on('click', function(){
        ...
        if($j(this).attr("data-value") !== "no"){
            ...
            newSkin ="body { background-image: none; }";
            jQuery('body').append('<style id="tootlbar_pattern_css" type="text/css">'+newSkin+'</style>');
        }
    });
