...
if ( stockholm_qode_options()->getOptionValue( 'portfolio_hide_pagination' ) == "yes" ) {
	$enable_navigation = false;
}

$portfolio_navigation_reverse_order = false;
if ( stockholm_qode_options()->getOptionValue( 'portfolio_navigation_reverse_order' ) == "yes" ) {
	$portfolio_navigation_reverse_order = true;
}

$navigation_through_category = false;
if ( stockholm_qode_options()->getOptionValue( 'portfolio_navigation_through_same_category' ) == "yes" ) {
