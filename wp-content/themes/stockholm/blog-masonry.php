...
<div class="container" <?php stockholm_qode_inline_page_background_style(); ?>>
	<div class="container_inner default_template_holder clearfix" <?php stockholm_qode_inline_page_padding_style(); ?>>
		...
		<?php elseif ( $qodef_sidebar == "1" || $qodef_sidebar == "2" ): ?>
			<div class="<?php if ( $qodef_sidebar == "1" ): ?>two_columns_66_33<?php elseif ( $qodef_sidebar == "2" ) : ?>two_columns_75_25<?php endif; ?> clearfix grid2 background_color_sidebar">
				<div class="column1">
		...
		<?php elseif ( $qodef_sidebar == "3" || $qodef_sidebar == "4" ): ?>
			<div class="<?php if ( $qodef_sidebar == "3" ): ?>two_columns_33_66<?php elseif ( $qodef_sidebar == "4" ) : ?>two_columns_25_75<?php endif; ?> grid2 clearfix background_color_sidebar">
				<div class="column1">
					<?php get_sidebar(); ?>
				</div>
				<div class="column2">
