...
class StockholmQodeIconsFontElegant implements iStockholmQodeIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	private function setSocialIconsArray() {
		...
		$this->socialIcons = array(
			""                          => "",
			"social_blogger"            => esc_html__( "Blogger", 'stockholm' ),
			"social_blogger_circle"     => esc_html__( "Blogger circle", 'stockholm' ),
			"social_blogger_square"     => esc_html__( "Blogger square", 'stockholm' ),
			"social_delicious"          => esc_html__( "Delicious", 'stockholm' ),
			"social_delicious_circle"   => esc_html__( "Delicious circle", 'stockholm' ),
			"social_delicious_square"   => esc_html__( "Delicious square", 'stockholm' ),
			"social_deviantart"         => esc_html__( "Deviantart", 'stockholm' ),
			"social_deviantart_circle"  => esc_html__( "Deviantart circle", 'stockholm' ),
			"social_deviantart_square"  => esc_html__( "Deviantart square", 'stockholm' ),
			"social_dribbble"           => esc_html__( "Dribbble", 'stockholm' ),
			"social_dribbble_circle"    => esc_html__( "Dribbble circle", 'stockholm' ),
			"social_dribbble_square"    => esc_html__( "Dribbble square", 'stockholm' ),
			"social_facebook"           => esc_html__( "Facebook", 'stockholm' ),
			"social_facebook_circle"    => esc_html__( "Facebook circle", 'stockholm' ),
			"social_facebook_square"    => esc_html__( "Facebook square", 'stockholm' ),
			"social_flickr"             => esc_html__( "Flickr", 'stockholm' ),
			"social_flickr_circle"      => esc_html__( "Flickr circle", 'stockholm' ),
			"social_flickr_square"      => esc_html__( "Flickr square", 'stockholm' ),
			"social_googledrive"        => esc_html__( "Googledrive", 'stockholm' ),
			"social_googledrive_alt2"   => esc_html__( "Googledrive alt2", 'stockholm' ),
			"social_googledrive_square" => esc_html__( "Googledrive square", 'stockholm' ),
			"social_googleplus"         => esc_html__( "Googleplus", 'stockholm' ),
			"social_googleplus_circle"  => esc_html__( "Googleplus circle", 'stockholm' ),
			"social_googleplus_square"  => esc_html__( "Googleplus square", 'stockholm' ),
			"social_instagram"          => esc_html__( "Instagram", 'stockholm' ),
			"social_instagram_circle"   => esc_html__( "Instagram circle", 'stockholm' ),
			"social_instagram_square"   => esc_html__( "Instagram square", 'stockholm' ),
			"social_linkedin"           => esc_html__( "Linkedin", 'stockholm' ),
			"social_linkedin_circle"    => esc_html__( "Linkedin circle", 'stockholm' ),
			"social_linkedin_square"    => esc_html__( "Linkedin square", 'stockholm' ),
			"social_myspace"            => esc_html__( "Myspace", 'stockholm' ),
			"social_myspace_circle"     => esc_html__( "myspace circle", 'stockholm' ),
			"social_myspace_square"     => esc_html__( "myspace square", 'stockholm' ),
			"social_picassa"            => esc_html__( "Picassa", 'stockholm' ),
			"social_picassa_circle"     => esc_html__( "Picassa circle", 'stockholm' ),
			"social_picassa_square"     => esc_html__( "Picassa square", 'stockholm' ),
			"social_pinterest"          => esc_html__( "Pinterest", 'stockholm' ),
			"social_pinterest_circle"   => esc_html__( "Pinterest circle", 'stockholm' ),
			"social_pinterest_square"   => esc_html__( "Pinterest square", 'stockholm' ),
			"social_rss"                => esc_html__( "Rss", 'stockholm' ),
			"social_rss_circle"         => esc_html__( "Rss circle", 'stockholm' ),
			"social_rss_square"         => esc_html__( "Rss square", 'stockholm' ),
			"social_share"              => esc_html__( "Share", 'stockholm' ),
			"social_share_circle"       => esc_html__( "Share circle", 'stockholm' ),
			"social_share_square"       => esc_html__( "Share square", 'stockholm' ),
			"social_skype"              => esc_html__( "Skype", 'stockholm' ),
			"social_skype_circle"       => esc_html__( "Skype circle", 'stockholm' ),
			"social_skype_square"       => esc_html__( "Skype square", 'stockholm' ),
			"social_spotify"            => esc_html__( "Spotify", 'stockholm' ),
			"social_spotify_circle"     => esc_html__( "Spotify circle", 'stockholm' ),
			"social_spotify_square"     => esc_html__( "Spotify square", 'stockholm' ),
			"social_stumbleupon_circle" => esc_html__( "Stumbleupon circle", 'stockholm' ),
			"social_stumbleupon_square" => esc_html__( "Stumbleupon square", 'stockholm' ),
			"social_tumbleupon"         => esc_html__( "Stumbleupon", 'stockholm' ),
			"social_tumblr"             => esc_html__( "Tumblr", 'stockholm' ),
			"social_tumblr_circle"      => esc_html__( "Tumblr circle", 'stockholm' ),
			"social_tumblr_square"      => esc_html__( "Tumblr square", 'stockholm' ),
			"social_twitter"            => esc_html__( "Twitter", 'stockholm' ),
			"social_twitter_circle"     => esc_html__( "Twitter circle", 'stockholm' ),
			"social_twitter_square"     => esc_html__( "Twitter square", 'stockholm' ),
			"social_vimeo"              => esc_html__( "Vimeo", 'stockholm' ),
			"social_vimeo_circle"       => esc_html__( "Vimeo circle", 'stockholm' ),
			"social_vimeo_square"       => esc_html__( "Vimeo square", 'stockholm' ),
			"social_wordpress"          => esc_html__( "Wordpress", 'stockholm' ),
			"social_wordpress_circle"   => esc_html__( "Wordpress circle", 'stockholm' ),
			"social_wordpress_square"   => esc_html__( "Wordpress square", 'stockholm' ),
			"social_youtube"            => esc_html__( "Youtube", 'stockholm' ),
			"social_youtube_circle"     => esc_html__( "Youtube circle", 'stockholm' ),
			"social_youtube_square"     => esc_html__( "Youtube square", 'stockholm' )
		);
	}
