...
if ( ! function_exists( 'stockholm_qode_init_google_fonts_array' ) ) {
	function stockholm_qode_init_google_fonts_array() {
...
';
		...
		$stockholm_fonts_array = $google_fonts_decoded['items'];
	}
	
	add_action('after_setup_theme', 'stockholm_qode_init_google_fonts_array');
}