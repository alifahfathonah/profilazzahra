...
if ( ! function_exists( 'stockholm_qode_font_awesome_icon_array' ) ) {
	/**
	 * Defines array of icons from Font Awesome
	 * @return array array of icons from Font Awesome
	 */
	function stockholm_qode_font_awesome_icon_array() {
...
if ( ! function_exists( 'stockholm_qode_font_awesome_social' ) ) {
	/**
	 * Defines social icons array from Font Awesome
	 * @return array array of social icons
	 */
	function stockholm_qode_font_awesome_social() {
		$icons = array(
			""                    => "",
			"fa-500px"            => "500px",
			"fa-adn"              => "ADN",
		...
		return apply_filters( 'stockholm_qode_font_awesome_social', $icons );
	}
}

if ( ! function_exists( 'stockholm_qode_font_awesome_social_vc' ) ) {
	/**
	 * Returns flipped array of social icons that is used for Visual Composer
	 * @return array flipped array of social icons
	 */
	function stockholm_qode_font_awesome_social_vc() {
		return array_flip( stockholm_qode_font_awesome_social() );
	}
}