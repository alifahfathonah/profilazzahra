...
if ( ! function_exists( 'stockholm_qode_font_elegant_icon_array' ) ) {
	/**
	 * Defines array of icons from Font Elegant
	 * @return array array of icons from Font Elegant
	 */
	function stockholm_qode_font_elegant_icon_array() {
		$icons = array(
...
if ( ! function_exists( 'stockholm_qode_font_elegant_social' ) ) {
	/**
	 * Defines social icons array from Font Awesome
	 * @return array array of social icons
	 */
	function stockholm_qode_font_elegant_social() {
		$icons = array(
			""                          => "",
			"social_blogger"            => esc_html__( "Blogger", 'stockholm' ),
			"social_blogger_circle"     => esc_html__( "Blogger_circle", 'stockholm' ),
			"social_blogger_square"     => esc_html__( "Blogger_square", 'stockholm' ),
			"social_delicious"          => esc_html__( "Delicious", 'stockholm' ),
			"social_delicious_circle"   => esc_html__( "Delicious_circle", 'stockholm' ),
			"social_delicious_square"   => esc_html__( "Delicious_square", 'stockholm' ),
			"social_deviantart"         => esc_html__( "Deviantart", 'stockholm' ),
			"social_deviantart_circle"  => esc_html__( "Deviantart_circle", 'stockholm' ),
			"social_deviantart_square"  => esc_html__( "Deviantart_square", 'stockholm' ),
			"social_dribbble"           => esc_html__( "Dribbble", 'stockholm' ),
			"social_dribbble_circle"    => esc_html__( "Dribbble_circle", 'stockholm' ),
			"social_dribbble_square"    => esc_html__( "Dribbble_square", 'stockholm' ),
			"social_facebook"           => esc_html__( "Facebook", 'stockholm' ),
			"social_facebook_circle"    => esc_html__( "Facebook_circle", 'stockholm' ),
			"social_facebook_square"    => esc_html__( "Facebook_square", 'stockholm' ),
			"social_flickr"             => esc_html__( "Flickr", 'stockholm' ),
			"social_flickr_circle"      => esc_html__( "Flickr_circle", 'stockholm' ),
			"social_flickr_square"      => esc_html__( "Flickr_square", 'stockholm' ),
			"social_googledrive"        => esc_html__( "Googledrive", 'stockholm' ),
			"social_googledrive_alt2"   => esc_html__( "Googledrive_alt2", 'stockholm' ),
			"social_googledrive_square" => esc_html__( "Googledrive_square", 'stockholm' ),
			"social_googleplus"         => esc_html__( "Googleplus", 'stockholm' ),
			"social_googleplus_circle"  => esc_html__( "Googleplus_circle", 'stockholm' ),
			"social_googleplus_square"  => esc_html__( "Googleplus_square", 'stockholm' ),
			"social_instagram"          => esc_html__( "Instagram", 'stockholm' ),
			"social_instagram_circle"   => esc_html__( "Instagram_circle", 'stockholm' ),
			"social_instagram_square"   => esc_html__( "Instagram_square", 'stockholm' ),
			"social_linkedin"           => esc_html__( "Linkedin", 'stockholm' ),
			"social_linkedin_circle"    => esc_html__( "Linkedin_circle", 'stockholm' ),
			"social_linkedin_square"    => esc_html__( "Linkedin_square", 'stockholm' ),
			"social_myspace"            => esc_html__( "Myspace", 'stockholm' ),
			"social_myspace_circle"     => esc_html__( "myspace_circle", 'stockholm' ),
			"social_myspace_square"     => esc_html__( "myspace_square", 'stockholm' ),
			"social_picassa"            => esc_html__( "Picassa", 'stockholm' ),
			"social_picassa_circle"     => esc_html__( "Picassa_circle", 'stockholm' ),
			"social_picassa_square"     => esc_html__( "Picassa_square", 'stockholm' ),
			"social_pinterest"          => esc_html__( "Pinterest", 'stockholm' ),
			"social_pinterest_circle"   => esc_html__( "Pinterest_circle", 'stockholm' ),
			"social_pinterest_square"   => esc_html__( "Pinterest_square", 'stockholm' ),
			"social_rss"                => esc_html__( "Rss", 'stockholm' ),
			"social_rss_circle"         => esc_html__( "Rss_circle", 'stockholm' ),
			"social_rss_square"         => esc_html__( "Rss_square", 'stockholm' ),
			"social_share"              => esc_html__( "Share", 'stockholm' ),
			"social_share_circle"       => esc_html__( "Share_circle", 'stockholm' ),
			"social_share_square"       => esc_html__( "Share_square", 'stockholm' ),
			"social_skype"              => esc_html__( "Skype", 'stockholm' ),
			"social_skype_circle"       => esc_html__( "Skype_circle", 'stockholm' ),
			"social_skype_square"       => esc_html__( "Skype_square", 'stockholm' ),
			"social_spotify"            => esc_html__( "Spotify", 'stockholm' ),
			"social_spotify_circle"     => esc_html__( "Spotify_circle", 'stockholm' ),
			"social_spotify_square"     => esc_html__( "Spotify_square", 'stockholm' ),
			"social_stumbleupon_circle" => esc_html__( "Stumbleupon_circle", 'stockholm' ),
			"social_stumbleupon_square" => esc_html__( "Stumbleupon_square", 'stockholm' ),
			"social_tumbleupon"         => esc_html__( "Stumbleupon", 'stockholm' ),
			"social_tumblr"             => esc_html__( "Tumblr", 'stockholm' ),
			"social_tumblr_circle"      => esc_html__( "Tumblr_circle", 'stockholm' ),
			"social_tumblr_square"      => esc_html__( "Tumblr_square", 'stockholm' ),
			"social_twitter"            => esc_html__( "Twitter", 'stockholm' ),
			"social_twitter_circle"     => esc_html__( "Twitter_circle", 'stockholm' ),
			"social_twitter_square"     => esc_html__( "Twitter_square", 'stockholm' ),
			"social_vimeo"              => esc_html__( "Vimeo", 'stockholm' ),
			"social_vimeo_circle"       => esc_html__( "Vimeo_circle", 'stockholm' ),
			"social_vimeo_square"       => esc_html__( "Vimeo_square", 'stockholm' ),
			"social_wordpress"          => esc_html__( "Wordpress", 'stockholm' ),
			"social_wordpress_circle"   => esc_html__( "Wordpress_circle", 'stockholm' ),
			"social_wordpress_square"   => esc_html__( "Wordpress_square", 'stockholm' ),
			"social_youtube"            => esc_html__( "Youtube", 'stockholm' ),
			"social_youtube_circle"     => esc_html__( "Youtube_circle", 'stockholm' ),
			"social_youtube_square"     => esc_html__( "Youtube_square", 'stockholm' )
		);
...
if ( ! function_exists( 'stockholm_qode_font_elegant_social_vc' ) ) {
	/**
	 * Returns flipped array of social icons that is used for Visual Composer
	 * @return array flipped array of social icons
	 */
	function stockholm_qode_font_elegant_social_vc() {
		return array_flip( stockholm_qode_font_elegant_social() );
	}
}