<?php
namespace Stockholm\Shortcodes\ProductListElegant;

use Stockholm\Shortcodes\Lib\ShortcodeInterface;

class ProductListElegant implements ShortcodeInterface {
	private $base;
	
	function __construct() {
		$this->base = 'qode_product_list_elegant';
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Product List Elegant', 'stockholm'),
			'base' => $this->base,
			...
			'params' => array(
					array(
						...
						'heading'    => esc_html__('Product Info Position', 'stockholm'),
						'value'      => array(
							esc_html__('Info On Image Hover', 'stockholm') => 'info-on-image',
							esc_html__('Info Below Image', 'stockholm')    => 'info-below-image'
						),
						'admin_label' => true,
					),
					array(
					...
					array(
						...
						'heading'     => esc_html__('Show Ordering Filter', 'stockholm'),
						'value'       => array_flip(stockholm_qode_get_yes_no_select_array(false, false)),
					),
					array(
						'type'       => 'textfield',
						'param_name' => 'price_range',
						'heading'    => esc_html__('Price range for pricing filter', 'stockholm'),
					...
					array(
						...
						'heading'     => esc_html__('Show Category Filter', 'stockholm'),
						'value'       => array_flip(stockholm_qode_get_yes_no_select_array(false, false)),
					),
					array(
						'type'        => 'textfield',
						'param_name'  => 'category_values',
						'heading'     => esc_html__('Enter Category Values', 'stockholm'),
				...
				array(
					...
					'heading'     => esc_html__('Show "All" Item in Filter', 'stockholm'),
					...
					array(
						...
						'heading'    => esc_html__('Product Info Skin', 'stockholm'),
						'value'      => array(
                    ...
                    array(
                        ...
                        'heading'    => esc_html__('Product Info Hover Background Skin', 'stockholm'),
                        'value'      => array(
                            esc_html__('Light', 'stockholm') => 'light',
                            esc_html__('Dark', 'stockholm') => 'dark'
                        ),
					...
					array(
						...
						'heading'    => esc_html__('Product Info Text Alignment', 'stockholm'),
						'value'      => array(
							esc_html__('Default', 'stockholm')  => '',
					...
					array(
						...
						'heading'    => esc_html__('Product Info Bottom Margin (px)', 'stockholm'),
						'dependency' => array('element' => 'info_position', 'value' => array('info-below-image')),
						'group'	     => esc_html__('Product Info Style', 'stockholm')
					)
				)
	...
	public function render($atts, $content = null) {
		...
		$html = stockholm_qode_get_woo_shortcode_module_template_part('templates/product-list-'.$params['type'], 'product-list', '', $params);
