...
if ( ! function_exists( 'stockholm_qode_register_theme_plugins' ) ) {
	/**
	 * Registers theme required and optional plugins. Hooks to tgmpa_register hook
	 */
	function stockholm_qode_register_theme_plugins() {
	...
	add_action( 'tgmpa_register', 'stockholm_qode_register_theme_plugins' );
}